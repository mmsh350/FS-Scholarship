          ...
          <div class="col-4 col-xl-4 page-title">
            ...
            <nav>
              <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
                ...
                <li class="breadcrumb-item f-w-400">Reports</li>
                <li class="breadcrumb-item f-w-400 active">Generate Reports</li>
              </ol>
            </nav>
          </div>
          <!-- Page Header Start-->
                  ...
                  <ul class="sidebar-links" id="simple-bar">
                    ...
                    <a class="sidebar-link sidebar-title active" href="javascript:void(0)">
                        ...
                        <ul class="sidebar-submenu expand">
                            ...
                            <li><a class="active" href="{{ route('admin.reports') }}">Generate Report</a></li> 
                        </ul>
                    </li>
                  </ul>
                </div>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <ul class="simple-wrapper nav nav-tabs" id="myTab" role="tablist">
                      <li class="nav-item" role="presentation"><a class="nav-link active txt-primary" id="school-tab" data-bs-toggle="tab" href="#school" role="tab" aria-controls="school" aria-selected="true" ><i class="icofont icofont-chart-histogram"></i>Revenue</a></li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                      ...
                      <div class="tab-pane active show fade" id="school" role="tabpanel" aria-labelledby="school-tab">
                        <h5 class="mt-4">Generate Revenue by Date Interval </h5>
                        <form>
                        <div class="row">
                        <div id="idcards" class=" mt-3 col-xxl-12 col-sm-6">
                          <label class="form-label" for="formFileMultiple">From</label>
                          <input class="form-control" name="date_from" id="date1" type="date">
                        </div>

                        <div id="idcards" class=" mt-3 col-xxl-12 col-sm-6">
                            <label class="form-label" for="formFileMultiple">To</label>
                            <input class="form-control" name="date_to" id="date2" type="date">
                          </div>
                      </div>
                      <div  class=" mt-3 col-xxl-12 col-sm-6">
                        <button class="btn btn-dark me-3" name="generate" id="generate" type="button">
                          <i class="icofont icofont-chart-histogram-alt"></i> Generate
                        </button>
                        <button class="btn btn-warning me-3" name="print" id="print" onclick="window.print();" type="button">
                          <i class="icofont icofont-printer"></i> Print
                        </button>
                      </div>

                        </form>

                      <div id="" class="  mt-3 col-xxl-12 col-sm-12">

                        <table border="1" class="table">
                            <thead style="background-color:#2b3751;">
                              <tr>
                                <th colspan="2" class="text-light"><i class="icofont icofont-chart-histogram">&nbsp;</i>Revenue Generated 
                            ...
                            <tbody>
                              <tr>
                                <th class="border-end">
                                  <span>Accured Interest </span>
                                <br> <span id="interest" class="f-w-300 f-16"> 0.00</span>
                                
                                </th>
                                <th><span>Upfront fee</span>
                                  <br><span id="upfront" class="f-w-300 f016">  0.00
                                  </span>
                                </th>
                              </tr>

                              <tr>
                                <th ><span class="txt-success">Grand Total</span>
                                    <br><span id="total" class="f-w-300 f016"> 0.00
                                    </span>
                                  </th>
                              </tr>
                            </tbody>
